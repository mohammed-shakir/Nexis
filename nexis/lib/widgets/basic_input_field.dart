...
class InputFieldState extends State<InputField> {
  ...
  EdgeInsets getContentPadding() {
    ...
    double rightPadding =
        0.0 + (gif ? 40 : 0) + (emoji ? 40 : 0) + (obscure ? 40 : 0);
    double leftPadding = 5.0 + (media ? 40 : 5.0);
    return EdgeInsets.only(
        right: rightPadding, left: leftPadding, top: 10, bottom: 10);
  }
    ...
    return RawKeyboardListener(
      ...
      child: Container(
        ...
        child: Column(children: [
          if (widget.files!.isNotEmpty && widget.onPressedMedia != null)
            StatefulBuilder(
          ...
          Stack(children: [
            TextFormField(
              ...
              style:
                  widget.fontStyle ?? Theme.of(context).textTheme.displayMedium,
              ...
              minLines: 1,
              maxLines:
                  (widget.multiline ?? false) ? (widget.maxLines ?? 1) : 1,
              ...
              decoration: InputDecoration(
                ...
                hintStyle:
                    widget.hintStyle ?? Theme.of(context).textTheme.labelSmall,
                border: buildBorder(widget.includeBorder, widget.borderRadius,
                    widget.borderColor, context),
                focusedBorder: buildBorder(widget.includeBorder,
                    widget.borderRadius, widget.focusedBorderColor, context),
                filled: true,
  ...
  OutlineInputBorder buildBorder([include, size, color, context]) {
    ...
    return OutlineInputBorder(
      borderRadius: widget.files!.isEmpty
